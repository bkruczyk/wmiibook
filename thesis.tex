...
\katedra{Katedrze Metod Matematycznych Informatyki}
...
\abstracteng{%
The paper presents a prototype blabalizator implementation
based on the theory of differential fetors $\sigma$-$\rho$ of Professor
Fifak. Using the theory of Fifak gives finally the
effective implementation of numerical blabaliza. This is
technological breakthrough, whose impact is hard to predict.
}%
